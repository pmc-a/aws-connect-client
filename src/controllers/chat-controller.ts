...
import { DisconnectParticipantResponse, SendMessageResponse } from 'aws-sdk/clients/connectparticipant';
...
class ConnectParticipantController {
    ...
    /**
     * Disconnects the participant from the session
     * It will use the current connectionToken that has been fetched by creating the overall session
     */
    disconnectParticipantConnection(): Promise<DisconnectParticipantResponse> {
        const params = {
            ConnectionToken: this.connectionToken,
        };

        const request = this.chatClient.disconnectParticipant(params);
...
export { ConnectParticipantController };
